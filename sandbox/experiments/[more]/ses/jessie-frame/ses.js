import makeHardener from './@agoric-make-hardener.js';
...
function tameDate() {
	...
	Object.defineProperties(newDateConstructor, Object.getOwnPropertyDescriptors(unsafeDate));
...
function removeProperties(global, whitelist) {
	...
	const {getOwnPropertyDescriptor: gopd, getOwnPropertyNames: gopn, keys} = Object;
...
function makeConsole(parentConsole) {
	...
	const newConsole = {};
	const passThrough = ['log', 'info', 'warn', 'error', 'group', 'groupEnd', 'trace', 'time', 'timeLog', 'timeEnd'];
